...
## 제거해야 할 AI 특유의 티(AI향)
- 상투적 접속/전환어 남발: "또한", "결론적으로", "궁극적으로", "다시 말해",
  "이러한 점에서", "종합적으로 볼 때" 등
- 기계적으로 균형 잡힌 문장: "~하지만 동시에 ~하기도 합니다" 식의 뻔한 양비론
- 나열체: "첫째, 둘째, 셋째"나 지나치게 규칙적인 번호/불릿 나열
- 과도한 헤지 표현: "~일 수도 있습니다", "~라고 볼 수 있습니다"의 반복
- 매 문단을 요약으로 마무리하는 습관 ("결국 중요한 것은 ~입니다" 반복)
- em dash(—)나 지나치게 대칭적인 문장 구조의 반복
- "함께 알아보겠습니다", "~에 대해 살펴보겠습니다" 같은 AI 도입부 클리셰
- 문장 길이가 전부 비슷비슷한 단조로운 리듬 (사람은 문장 길이를 들쭉날쭉하게 씁니다)
...
- 한국어로 자연스럽게, 실제 사람이 X에 편하게 쓴 듯한 리듬과 어휘로 다듬습니다.
